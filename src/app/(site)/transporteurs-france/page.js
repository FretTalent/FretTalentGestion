...
const pageKey = 'transporteurs-france';
...
const jsonLd = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Transporteurs France', item: `https://www.frettalent.fr/${pageKey}` },
    ],
  },
  {
    '@context': 'https://schema.org',
...
export default function TransporteursFrancePage() {
  return (
    <SeoLandingTemplate
      h1={data.h1}
