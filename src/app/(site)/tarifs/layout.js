export const metadata = {
  ...
  keywords: [
    ...
    'abonnement recrutement transport',
  ],
  alternates: {
  ...
  openGraph: {
    title: 'Tarifs Recrutement Chauffeur SPL & Transporteurs | FretTalent',
    description:
      'Tarifs transparents : 2€ par contact ou forfait illimité à 39,99€/mois. 0% de commission d\'intérim.',
    url: 'https://www.frettalent.fr/tarifs',
  },
};
