...
const pageKey = 'chauffeur-spl-aisne';
...
const jsonLd = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Chauffeur SPL Aisne (02)', item: `https://www.frettalent.fr/${pageKey}` },
    ],
  },
  {
    '@context': 'https://schema.org',
...
export default function ChauffeurSplAisnePage() {
  return (
    <SeoLandingTemplate
      h1={data.h1}
