              ...
              <div className="relative w-full flex items-center bg-slate-50 py-6 rounded-2xl border border-slate-100">
                ...
                <div className="flex overflow-hidden w-full">
                  ...
                  <div className="animate-marquee flex items-center gap-16 pr-16">
                    ...
                    <img src="https://epca.eu/sites/epca.eu/files/company-logo/Geodis.png" alt="Geodis" className="h-8 md:h-10 object-contain grayscale hover:grayscale-0 opacity-70 hover:opacity-100 transition-all duration-300" />
