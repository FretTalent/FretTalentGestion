              ...
              <div className="relative w-full flex items-center bg-slate-50 py-6 rounded-2xl border border-slate-100">
                ...
                <div className="flex overflow-hidden w-full">
                  ...
                  <div className="animate-marquee flex items-center gap-24 pr-24">
                    <img src="https://get-picto.com/wp-content/uploads/2023/07/amazon-logo-png.webp" alt="Amazon" className="h-8 md:h-10 object-contain flex-shrink-0 opacity-70 hover:opacity-100 transition-all duration-300 [filter:sepia(1)_saturate(3000%)_hue-rotate(345deg)_brightness(95%)] hover:[filter:none]" />
                    <img src="https://koerber-supplychain.com/fileadmin/_processed_/a/b/csm_reference_db-schenker_logo_814c09a032.png" alt="DB Schenker" className="h-8 md:h-10 object-contain flex-shrink-0 opacity-70 hover:opacity-100 transition-all duration-300 [filter:sepia(1)_saturate(3000%)_hue-rotate(345deg)_brightness(95%)] hover:[filter:none]" />
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/XPO_Logistics_logo.svg/1280px-XPO_Logistics_logo.svg.png" alt="XPO Logistics" className="h-6 md:h-8 object-contain flex-shrink-0 opacity-70 hover:opacity-100 transition-all duration-300 [filter:sepia(1)_saturate(3000%)_hue-rotate(345deg)_brightness(95%)] hover:[filter:none]" />
                    <img src="https://images.seeklogo.com/logo-png/18/2/translux-logo-png_seeklogo-187301.png" alt="Translux" className="h-8 md:h-10 object-contain flex-shrink-0 opacity-70 hover:opacity-100 transition-all duration-300 [filter:sepia(1)_saturate(3000%)_hue-rotate(345deg)_brightness(95%)] hover:[filter:none]" />
                    <img src="https://epca.eu/sites/epca.eu/files/company-logo/Geodis.png" alt="Geodis" className="h-8 md:h-10 object-contain flex-shrink-0 opacity-70 hover:opacity-100 transition-all duration-300 [filter:sepia(1)_saturate(3000%)_hue-rotate(345deg)_brightness(95%)] hover:[filter:none]" />
                    <img src="https://i.pinimg.com/originals/27/87/7b/27877bcbab95edc899c251e48af48fc3.png" alt="Logistics Carrier" className="h-8 md:h-10 object-contain flex-shrink-0 opacity-70 hover:opacity-100 transition-all duration-300 [filter:sepia(1)_saturate(3000%)_hue-rotate(345deg)_brightness(95%)] hover:[filter:none]" />
                  </div>
                  {/* Deuxième set identique pour boucler à l'infini sans coupure */}
                  <div className="animate-marquee flex items-center gap-24 pr-24" aria-hidden="true">
                    <img src="https://get-picto.com/wp-content/uploads/2023/07/amazon-logo-png.webp" alt="Amazon" className="h-8 md:h-10 object-contain flex-shrink-0 opacity-70 hover:opacity-100 transition-all duration-300 [filter:sepia(1)_saturate(3000%)_hue-rotate(345deg)_brightness(95%)] hover:[filter:none]" />
                    <img src="https://koerber-supplychain.com/fileadmin/_processed_/a/b/csm_reference_db-schenker_logo_814c09a032.png" alt="DB Schenker" className="h-8 md:h-10 object-contain flex-shrink-0 opacity-70 hover:opacity-100 transition-all duration-300 [filter:sepia(1)_saturate(3000%)_hue-rotate(345deg)_brightness(95%)] hover:[filter:none]" />
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/XPO_Logistics_logo.svg/1280px-XPO_Logistics_logo.svg.png" alt="XPO Logistics" className="h-6 md:h-8 object-contain flex-shrink-0 opacity-70 hover:opacity-100 transition-all duration-300 [filter:sepia(1)_saturate(3000%)_hue-rotate(345deg)_brightness(95%)] hover:[filter:none]" />
                    <img src="https://images.seeklogo.com/logo-png/18/2/translux-logo-png_seeklogo-187301.png" alt="Translux" className="h-8 md:h-10 object-contain flex-shrink-0 opacity-70 hover:opacity-100 transition-all duration-300 [filter:sepia(1)_saturate(3000%)_hue-rotate(345deg)_brightness(95%)] hover:[filter:none]" />
