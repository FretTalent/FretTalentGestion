...
console.log('\n========================================');
console.log('🔧 MIGRATION: Ajout abonnement entreprise');
console.log('========================================\n');
...
async function runMigration() {
  ...
  const sqlCommands = [
    `ALTER TABLE public.companies ADD COLUMN IF NOT EXISTS subscription_plan VARCHAR(50) NOT NULL DEFAULT 'pay_per_unlock'`
  ];
