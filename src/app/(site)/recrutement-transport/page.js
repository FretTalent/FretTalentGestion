...
const pageKey = 'recrutement-transport';
...
const jsonLd = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Recrutement Transport', item: `https://www.frettalent.fr/${pageKey}` },
    ],
  },
  {
    '@context': 'https://schema.org',
...
export default function RecrutementTransportPage() {
  return (
    <SeoLandingTemplate
      h1={data.h1}
