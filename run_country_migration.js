// Exécute la migration SQL pour LU et CH via pg
const fs = require('fs');
...
console.log('\n======================================================');
console.log('🔧 MIGRATION: Ajout Luxembourg & Suisse (LU & CH)');
console.log('======================================================\n');
...
async function runMigration() {
  ...
  if (!connected) {
    console.log('\n📋 INSTRUCTIONS MANUELLES: Executez ceci dans supabase SQL editor:');
