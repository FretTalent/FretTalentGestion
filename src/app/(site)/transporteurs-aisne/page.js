...
const pageKey = 'transporteurs-aisne';
...
const jsonLd = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Transporteurs Aisne (02)', item: `https://www.frettalent.fr/${pageKey}` },
    ],
  },
  {
    '@context': 'https://schema.org',
...
export default function TransporteursAisnePage() {
  return (
    <SeoLandingTemplate
      h1={data.h1}
