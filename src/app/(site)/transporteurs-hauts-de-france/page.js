...
const pageKey = 'transporteurs-hauts-de-france';
...
const jsonLd = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Transporteurs Hauts-de-France', item: `https://www.frettalent.fr/${pageKey}` },
    ],
  },
  {
    '@context': 'https://schema.org',
...
export default function TransporteursHautsDeFrancePage() {
  return (
    <SeoLandingTemplate
      h1={data.h1}
