...
const pageKey = 'chauffeur-spl-hauts-de-france';
...
const jsonLd = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Chauffeur SPL Hauts-de-France', item: `https://www.frettalent.fr/${pageKey}` },
    ],
  },
  {
    '@context': 'https://schema.org',
...
export default function ChauffeurSplHautsDeFrancePage() {
  return (
    <SeoLandingTemplate
      h1={data.h1}
