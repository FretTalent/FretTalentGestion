...
const pageKey = 'emploi-chauffeur';
...
const jsonLd = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Emploi Chauffeur', item: `https://www.frettalent.fr/${pageKey}` },
    ],
  },
  {
    '@context': 'https://schema.org',
...
export default function EmploiChauffeurPage() {
  return (
    <SeoLandingTemplate
      h1={data.h1}
