...
export const metadata = {
  title: "Tarifs de Recrutement Chauffeurs Routiers - Forfaits & Usage | FretTalent",
  description: "Découvrez nos offres claires et sans surprise. À la performance à 2€ par contact ou forfait illimité à 49,99€/mois avec déblocage des documents officiels.",
};

export default function Tarifs() {
  const jobboards = [
    { name: "Indeed", cost: "150 € à 1 200 € / mois", ads: "Limité / Payant CPC", docs: "Non vérifiés", specialization: "Généraliste", commitment: "Frais au clic variables" },
    { name: "Leboncoin", cost: "276 € à 1 500 € / mois", ads: "Payant à l'unité", docs: "Indisponibles", specialization: "Généraliste", commitment: "Paiement à la durée d'annonce" },
    { name: "Monster", cost: "1 000 € à 2 000 € / mois", ads: "Limité par licence", docs: "Non vérifiés", specialization: "Généraliste", commitment: "Abonnement annuel rigide" },
    { name: "Cadremploi / StepStone", cost: "2 000 € à 4 000 € / mois", ads: "Payant à l'annonce", docs: "Non vérifiés", specialization: "Cadres / Tertiaire", commitment: "Contrat à engagement long" },
    { name: "Talent.com", cost: "Minimum 500 € / mois", ads: "CPC publicitaire", docs: "Indisponibles", specialization: "Généraliste", commitment: "Budget mensuel obligatoire" },
    { name: "LinkedIn", cost: "Minimum 300 € / mois", ads: "Limité / CPC", docs: "Non vérifiés", specialization: "Réseau Pro Généraliste", commitment: "Budget quotidien variable" },
  ];
  ...
  return (
    <div className="bg-white text-slate-900 font-sans selection:bg-orange-500 selection:text-white">
      ...
      <section className="py-20 bg-gradient-to-b from-slate-50 to-white border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
          ...
          <p className="text-slate-600 text-lg max-w-2xl mx-auto">
            Trouvez vos chauffeurs routiers selon vos besoins réels. Pas de commissions d'embauche, pas de frais cachés.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="bg-white border-2 border-slate-200 rounded-3xl p-8 flex flex-col justify-between hover:border-slate-300 transition-all duration-300 shadow-sm hover:shadow-md relative">
            <div className="space-y-6">
              <div>
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider bg-slate-105 px-2.5 py-1 rounded-md">Usage ponctuel</span>
                <h3 className="text-xl font-bold text-slate-950 mt-3">À la performance</h3>
                <p className="text-xs text-slate-500 mt-1">Idéal pour combler des besoins en recrutement très occasionnels.</p>
              </div>
              ...
              <ul className="space-y-4 text-xs text-slate-650">
                <li className="flex items-start gap-3">
                  ...
                  <span>Accès complet aux coordonnées (Téléphone, E-mail, Nom)</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-4.5 w-4.5 text-orange-500 flex-shrink-0 mt-0.5" />
                  <span><strong>Déblocage des documents officiels obligatoires</strong> du candidat (Permis C/CE, FIMO/FCO, Carte conducteur...)</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-4.5 w-4.5 text-orange-500 flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-4.5 w-4.5 text-orange-500 flex-shrink-0 mt-0.5" />
                  <span>Facturation post-payée Stripe en fin de mois au réel</span>
                </li>
              </ul>
            </div>
          ...
          <div className="bg-white border-2 border-orange-500 rounded-3xl p-8 flex flex-col justify-between shadow-xl relative">
            ...
            <div className="space-y-6">
              <div>
                <span className="text-[10px] font-bold text-orange-600 uppercase tracking-wider bg-orange-50 px-2.5 py-1 rounded-md">Recrutement Actif</span>
                <h3 className="text-xl font-bold text-slate-955 mt-3">Forfait Illimité Pro</h3>
                <p className="text-xs text-slate-500 mt-1">Idéal pour les flottes actives qui recrutent régulièrement et publient des offres.</p>
              </div>
              ...
              <ul className="space-y-4 text-xs text-slate-650">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-4.5 w-4.5 text-orange-500 flex-shrink-0 mt-0.5" />
                  <span><strong>Déblocages et coordonnées candidats illimités</strong></span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-4.5 w-4.5 text-orange-500 flex-shrink-0 mt-0.5" />
                  <span><strong>Accès illimité aux documents officiels</strong> (Permis, FIMO, chronotachygraphe, habilitations ADR...)</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-4.5 w-4.5 text-orange-500 flex-shrink-0 mt-0.5" />
                  <span><strong>Publication d'offres d'emploi illimitée</strong> diffusées en direct sur le site</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-4.5 w-4.5 text-orange-500 flex-shrink-0 mt-0.5" />
                  <span><strong>Accès prioritaire 24h avant</strong> sur tous les nouveaux candidats inscrits sur la plateforme</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-4.5 w-4.5 text-orange-500 flex-shrink-0 mt-0.5" />
                  <span><strong>Alertes e-mail temps réel</strong> sur critères de recherche (permis, localisation)</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-4.5 w-4.5 text-orange-500 flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-4.5 w-4.5 text-orange-500 flex-shrink-0 mt-0.5" />
                  <span className="font-semibold text-orange-655">Sans engagement, résiliable en 1 clic</span>
                </li>
              </ul>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <p className="text-slate-600 text-sm">
              Découvrez les différences de budget et de fonctionnalités entre les plateformes généralistes et notre solution dédiée au transport routier.
            </p>
          </div>
              ...
              <table className="w-full text-left border-collapse min-w-[800px]">
                <thead>
                  <tr className="bg-slate-900 text-white text-xs uppercase tracking-wider font-bold">
                    ...
                    <th className="p-4 border-r border-slate-800">Coût Mensuel Estimé</th>
                    <th className="p-4 border-r border-slate-800">Offres d'emploi</th>
                    <th className="p-4 border-r border-slate-800">Justificatifs Candidats</th>
                ...
                <tbody className="text-xs divide-y divide-slate-100">
                  ...
                  <tr className="bg-orange-50/40 font-semibold text-slate-900">
                    ...
                    <td className="p-4 border-r border-slate-100 text-slate-950 font-black">49,99 € / mois</td>
                    <td className="p-4 border-r border-slate-100 text-green-700">Publication Illimitée</td>
                    <td className="p-4 border-r border-slate-100 text-green-700">Documents officiels vérifiés & illimités</td>
                    <td className="p-4 border-r border-slate-100 text-green-700">Oui (100% Métiers de la Route)</td>
                    <td className="p-4 text-slate-850">Aucun engagement / Aucun surcoût</td>
                  </tr>

                  {/* Jobboards généraux */}
                  {jobboards.map((board, idx) => (
                    <tr key={idx} className="hover:bg-slate-50/50 text-slate-650">
                      <td className="p-4 border-r border-slate-100 font-bold text-slate-800">{board.name}</td>
                      <td className="p-4 border-r border-slate-100 font-medium">{board.cost}</td>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start pt-6">
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-slate-950 flex items-center gap-2">
                <TrendingDown className="h-5 w-5 text-orange-500" /> Analyse détaillée des coûts de diffusion
              </h3>
            ...
            <div className="bg-white p-6 rounded-3xl border border-slate-200 space-y-4 shadow-sm">
              <h3 className="text-sm font-bold text-slate-900 uppercase tracking-wider">Synthèse des Économies Réalisées</h3>
          ...
          <div className="bg-slate-900 text-white p-8 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="space-y-2">
              <h4 className="text-base font-bold text-white">Pourquoi payer plus cher pour des profils non qualifiés ?</h4>
              <p className="text-xs text-slate-400 max-w-2xl">
                Bénéficiez dès aujourd'hui d'une plateforme métier configurée exclusivement pour le recrutement de transport routier. Dépôts illimités et accès au dossier administratif candidat complet.
              </p>
            </div>
            <Link 
              href="/register?role=recruiter" 
      ...
      <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
        <h2 className="text-2xl font-bold text-slate-950">Une question sur nos forfaits ?</h2>
        <p className="text-sm text-slate-500 max-w-2xl mx-auto">
          Notre équipe commerciale est disponible 7j/7 pour vous accompagner dans le paramétrage de vos offres et la configuration de votre tableau de bord.
        </p>
        <Link 
