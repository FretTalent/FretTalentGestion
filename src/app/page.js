            ...
            <div className="mt-20 pt-16 border-t border-slate-100 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-orange-50/30 border-l-4 border-orange-500 rounded-r-2xl space-y-1">
                    <h4 className="text-sm font-bold text-slate-900">Jusqu'à 10 fois moins cher</h4>
                    <p className="text-xs text-slate-600">Là où une agence d'intérim applique des coefficients multiplicateurs élevés sur chaque heure travaillée (représentant des milliers d'euros par mois), FretTalent vous facture seulement 2 € par contact qualifié ou un forfait fixe sans engagement.</p>
                  </div>
                  <div className="p-4 bg-slate-50 border-l-4 border-slate-400 rounded-r-2xl space-y-1">
                    <h4 className="text-sm font-bold text-slate-900">Une spécialisation 100% Transport & Logistique</h4>
                    <p className="text-xs text-slate-600">Contrairement aux agences généralistes, notre plateforme est développée exclusivement pour les métiers de la route. Les profils intègrent nativement les permis PL/SPL, les habilitations ADR, la validité FIMO/FCO et la gestion de la carte chronotachygraphe.</p>
                  </div>
                </div>
              </div>
              <div className="bg-slate-900 text-white p-8 rounded-3xl space-y-6 shadow-xl">
                ...
                <div className="text-center pt-2">
                  <Link href="/entreprises" className="text-xs font-bold text-orange-400 hover:underline">
